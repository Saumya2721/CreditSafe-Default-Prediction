...
├── data/
│   ├── raw/                  # Original competition CSVs (not tracked by git)
│   │   ├── cs-training.csv
│   │   └── cs-test.csv
│   └── processed/            # Cleaned & feature-engineered output (generated by notebook)
├── notebooks/
│   └── 01_EDA_and_Modeling.ipynb   # Main analysis notebook
├── src/
│   ├── preprocessing.py      # Data cleaning & imputation logic
